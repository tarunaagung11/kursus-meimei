    ...
    return (
        <div className='demo' id='demo'>
            <div className='container'>
                ...
                <div className='col-2'>
                    <iframe width='570' height='320' src='https://desty.page/kursusmeimeijiaoyu' title='desty.page' frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
                </div>
            </div>
        </div>
    )
